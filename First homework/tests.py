...
class MyTestTicTacToe(unittest.TestCase):
	...
	def test_tiy_game(self):
		self.field = TicTacToe()
		self.assertEqual(self.field.whose_last_turn, False)  # |2|6|5|   |0|0|X|
		self.assertEqual(self.field.turn(1, 1), False)       # |8|1|4|   |X|X|0|
		self.assertEqual(self.field.whose_last_turn, True)   # |9|7|3|   |0|X|X|
		self.assertEqual(self.field.turn(0, 0), False)
		self.assertEqual(self.field.whose_last_turn, False)
		self.assertEqual(self.field.turn(2, 2), False)
		self.assertEqual(self.field.whose_last_turn, True)
	...
	def test_player1_win(self):
		self.field = TicTacToe()
		self.assertEqual(self.field.whose_last_turn, False)  # |7| |4|   |X| |0|
		self.assertEqual(self.field.turn(1, 1), False)       # |5|1|6|   |X|X|0|
		self.assertEqual(self.field.whose_last_turn, True)   # |3|2| |   |X|0| |
		self.assertEqual(self.field.turn(1, 2), False)
		self.assertEqual(self.field.whose_last_turn, False)
		self.assertEqual(self.field.turn(0, 2), False)
		self.assertEqual(self.field.whose_last_turn, True)
	...
	def test_player2_win(self):
		self.field = TicTacToe()
		self.assertEqual(self.field.whose_last_turn, False)  # | | |2|   | | |0|
		self.assertEqual(self.field.turn(1, 1), False)       # |5|1|4|   |X|X|0|
		self.assertEqual(self.field.whose_last_turn, True)   # |3| |6|   |X| |0|
		self.assertEqual(self.field.turn(2, 0), False)
		self.assertEqual(self.field.whose_last_turn, False)
		self.assertEqual(self.field.turn(0, 2), False)
		self.assertEqual(self.field.whose_last_turn, True)
